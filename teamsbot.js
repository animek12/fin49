// RAFFXTEAMS
// DATA DATA PROTECT SECURITY
// PAKE AJA SC NYA ASAL JANGAN DI JUAL
// MAU UPLOD YT? TAG GUA/AUTHOR
...
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
// FITIR + FITUR + DATA DATA + ALL SECURITY //
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
// teamsdata
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
"use strict";
...
const { color, bgcolor, pickRandom, randomNomor } = require('./teamsdata/Data_Server_Bot/Console_Data')
const { removeEmojis, bytesToSize, getBuffer, fetchJson, getRandom, getGroupAdmins, runtime, sleep, makeid, isUrl, generateProfilePicture } = require("./teamsdata/func_Server");
const { TelegraPh, UploadFileUgu, AnonFiles } = require("./teamsdata/uploader_Media");
const { addResponList, delResponList, isAlreadyResponList, isAlreadyResponListGroup, sendResponList, updateResponList, getDataResponList } = require('./teamsdata/func_Addlist');
const { media_JSON, mess_JSON, setting_JSON, antilink_JSON, db_user_JSON, server_eror_JSON, welcome_JSON, db_menfes_JSON, db_respon_list_JSON, auto_downloadTT_JSON } = require('./teamsdata/Data_Location.js')
const { mediafireDl } = require('./teamsdata/scrape_Mediafire')
const { webp2mp4File } = require("./teamsdata/Webp_Tomp4")
const { cerpen } = require('./teamsdata/Search_Cerpen')
...
const { jadibot, listJadibot } = require('./teamsdata/jadibot')
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
//Virtex data
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
const { philips } = require('./teamsdata/virtex/philips')
const { virus } = require('./teamsdata/virtex/virus')
const { ngazap } = require('./teamsdata/virtex/ngazap')
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/    
//Node modul
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
const fs = require("fs");
...
// Sticker wm
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/    
const Exif = require("./teamsdata/set_WM_Sticker")
const exif = new Exif()
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/    
//teamsdata
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
const msgFilter = require("./teamsdata/func_Spam");
const { stalkff, stalkml } = require("./teamsdata/func_Stalker");
const teamsbot = fs.readFileSync ('./teamsdata/teamsbot.jpg')
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
//Autowarn
/*━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
let orang_spam = []
...
const isOwner = [`${setting.ownerNumber}`,"6281328139682@s.whatsapp.net","6281328139682@s.whatsapp.net"].includes(sender) ? true : false
...
const PathAuto = "./teamsdata/menuPath/"
...
participant: `0@s.whatsapp.net`, ...(from ? 
	 ...
	 message: { 
"extendedTextMessage": {
 "text": `Hallo, ${ucapanWaktu} ${pushname}`,
 "title": `Hallo ${pushname}`,
 'jpegThumbnail': fs.readFileSync("./database/apa.jpg")
}
	  } 
}
...
const gurbot = '6281328139682@s.whatsapp.net'
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`© TEAMS BOT 2022`
...
conn.sendMessage(from, but_menu, {quoted:ftex})
}
break
case 'donate':
case 'donasi':{
...
*author:* wikimedia`
conn.sendMessage(from, { image:{url:wk.result.image}, caption:text_wikimedia}, {quoted:ftex})
})
}
break
case 'joker':
...
var raffx = '6281328139682@s.whatsapp.net'
conn.sendMessage(raffx, {text: teks + teks1, mentions:[sender]}, {quoted:msg})
...
axios.get(`https://${hostwhm}:2087/json-api/createacct?api.version=1&username=${usern}&contactemail=raflimaulanbegal15@gmail.com&plan=${pekeg}&domain=${domain}`, authWhm)
.then(response => {     
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by raffx' })
}
console.log(feta)
}
break
...
if (!q) return reply('link githubnya mana?\n*Contoh:*\n#gitclone https://github.com/raffx24/MenfessV1')
var linknya = q
...
.then(data => {
var opt = { packname: 'BOT TEAMS MD', author: 'Raffx Teams' }
...
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
const x35  = JSON.parse(fs.readFileSync(`./teamsdata/Random_IMAGE/${command}.json`)); 
...
if (cekUser("premium", sender) == false) return reply(mess.OnlyPrem)
reply(mess.wait)
const x33 = JSON.parse(fs.readFileSync(`./teamsdata/Random_IMAGE/${command}.json`)); 
...
var dev = '6281328139682@s.whatsapp.net'
